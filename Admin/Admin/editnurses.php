...
<?php 
 ...
 //session_start();
  ...
  $sql="SELECT * FROM nurses WHERE n_id='".$_GET['id']."'";
...
{ 
    ...
    $ph=$_POST['phone'];
     ...
     $pass=$_POST['password'];
      ...
      $write =$conn->query("UPDATE nurses SET firstname=' $fn',middlename='$mn',lastname='$ln',username='$usern',phone='$ph',idno='$idn',password='$pass' WHERE  n_id='".$_GET['id']."'") or die(mysqli_error());
     ...
     echo " <script>alert('Nurse Record Updated Successfully..');</script>";
      echo " <script>setTimeout(\"location.href='attendant.php';\",150);</script>";
    }
...
<div class="content-wrapper">
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Update Nurse Personal Info
        </li>
      </ol>
    </section>
  ...
  <div class="col-xs-12">
    <div class="box box-primary">
      <div class="box-header with-border ">
        <i class="fa fa-user"></i> <h3 class="box-title">Update Nurse Personal Info</h3>
