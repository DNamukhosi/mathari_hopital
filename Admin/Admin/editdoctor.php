...
{ 
    ...
    $ph=$_POST['phone'];
     ...
     $pass=$_POST['password'];
      ...
      $write =$conn->query("UPDATE doctors SET firstname=' $fn',middlename='$mn',lastname='$ln',username='$usern',phone='$ph',idno='$idn',password='$pass' WHERE  d_id='".$_GET['id']."'") or die(mysqli_error());
     ...
     echo " <script>alert('Records Successfully Updated..');</script>";
      echo " <script>setTimeout(\"location.href='doctor.php';\",150);</script>";
    }
...
<div class="content-wrapper">
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Update Doctor Personal Info
        </li>
      </ol>
    </section>
  ...
  <div class="col-xs-12">
    <div class="box box-primary">
      <div class="box-header with-border ">
        <i class="fa fa-user"></i> <h3 class="box-title">Update Doctor Personal Info</h3>
