...
$dno=$code.$ln;
$write="INSERT INTO `words`(`w_id`,`name`,`description`,`capacity`,`available`) VALUES ('$dno','$fname','$lname','$beds','$avai')";
...
<div class="content-wrapper">
    <section class="content-header">  
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Wards</a></li>
  ...
  <div class="col-xs-12">
    <div class="box box-primary">
      <div class="box-header with-border ">
        <i class="fa fa-user"></i> <h3 class="box-title">WARDS</h3>
      </div>
      ...
      <div class="modal fade" id="myModal" role="dialog">
       <div class="modal-dialog">
        <div class="modal-content">
          ...
          <h4 class="modal-title"> Add a Ward</h4>
          </div>
          <div class="modal-body">
            <form method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
              <label for="exampleInputPassword1">Beds Capacity</label>
              <input type="text" name="beds" class="form-control" placeholder="Enter no of beds" required="required" pattern="[0-9]{0-3}" title="Enter numeric characters only">
              </div>
...
<td><a href="editwords.php?id=<?php echo $row['w_id']; ?>"><span class="btn btn-success bg-green"><i class="fa fa-edit"></i> Edit </span></a>
 <a href="deletew.php?id=<?php echo $row['d_id']; ?>"><span class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete </span></a></td>
</tr>
<?php }
$conn->close();
  ?>
