     ...
     if($nrows==null)
      {
        $write =$conn->query("INSERT INTO sys_user(`user_id`,`username`,`password`,`level`) VALUES ('$dno','$username','$password','$id')") or die(mysqli_error());
            ...
            $writex =$conn->query("INSERT INTO nurses(`n_id`,`firstname`,`middlename`,`lastname`,`username`,`phone`,`idno`,`password`) VALUES ('$dno','$fname','$mname','$lname','$username','$phone','$idno','$password')") or die(mysqli_error());
...
<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Nurses</a></li>
        <li class="active">Nurse - List</li>
      </ol>
    </section>
  ...
  <div class="col-xs-12">
    <div class="box box-primary">
      <div class="box-header with-border ">
        <i class="fa fa-user"></i> <h3 class="box-title">NURSES</h3>
      </div>
...
$query=$conn->query("SELECT n_id,concat(firstname,' ',middlename,' ',lastname) as name,username,phone,idno FROM nurses order by n_id")or die (mysqli_error());
...
<td><a href="editnurses.php?id=<?php echo $row['n_id']; ?>"><span class="btn btn-success bg-green"><i class="fa fa-edit"></i> Edit </span></a>
 <a href="delete1.php?id=<?php echo $row['n_id']; ?>"><span class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete </span></a></td>
</tr>
<?php }
$conn->close();
  ?>
