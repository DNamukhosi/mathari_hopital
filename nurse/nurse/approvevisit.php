...
if(isset($_POST['submit']))
{
  ...
  $vis = $conn->query("SELECT * FROM `p_visitor` where v_id='$fname'") or die(mysqli_error());
        ...
        <i class="fa fa-user"></i> <h3 class="box-title">APPROVE VISITORS</h3>
         ...
         <div class="box-header">
            <form method="POST" enctype="multipart/form-data">
                ...
                <input type="text" name="id" class="form-control" placeholder="Enter ID" onmouseleave="getAmt(this.value);" required="required">
               </div>
                <div id="subject">
