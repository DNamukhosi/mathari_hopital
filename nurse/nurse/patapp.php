...
{ 
    ...
    if($date >= $ddt ){
$write =$conn->query("INSERT INTO `p_appointments`(`p_id`,`name`,`date`,`temp`,`bp`,`weight`, `attended`) VALUES ('$vid1','$name','$date','$temp','$bp','$weight','$att')") or die(mysqli_error());
    ...
    <div class="box box-primary">
      ...
      <form method="POST" enctype="multipart/form-data" >
         ...
         <div class="form-group">
               ...
               <div class="form-group">
                <label for="exampleInputEmail1">Body Temparature(deg. C)</label>
                <input type="number" name="temp" min="30" max="40" class="form-control" placeholder="enter patient's temparature" required="">
               </div>
               <div class="form-group">
                <label for="exampleInputEmail1">Weight(Kg)</label>
                <input type="number" name="weight" min="1" max="300" class="form-control" placeholder="enter patient's weight in Kgs" required="">
               </div>
               <div class="form-group">
                <label for="exampleInputEmail1">Blood Pressure</label>
                <input type="number" name="bp" min="50" max="200"  class="form-control" placeholder="enter patient's BP" required="required">
               </div>
               <div class="form-group">
