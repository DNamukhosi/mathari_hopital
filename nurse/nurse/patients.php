...
$dno=$code.$ln;
 ...
 $ddt = date("Y-m-d");
		...
		if($dob < $ddt ){
            $writex =$conn->query("INSERT INTO patients(`p_id`,`firstname`,`middlename`,`lastname`,`dob`,`phone_no`,`idno`,`physical_location`,`occupation`,`marital_status`) VALUES ('$dno','$fname','$mname','$lname','$dob','$phone','$idno','$loc','$occ','$status')") or die(mysqli_error());
